<template>
    <div class="panel-tab__content">
        <el-form :model="flowConditionForm"
            ...
            <el-form-item v-if="flowConditionForm.type === 'condition'"
                          key="condition"
                          label="条件格式">
            ...
            <el-form-item v-if="flowConditionForm.conditionType && flowConditionForm.conditionType === 'expression'"
                          key="express"
                          label="表达式">
            ...
            <template v-if="flowConditionForm.conditionType && flowConditionForm.conditionType === 'script'">
                <el-form-item key="language"
                              label="脚本语言">
                    <el-input v-model="flowConditionForm.language"
                              clearable
                              @change="updateFlowCondition" />
                </el-form-item>
                <el-form-item key="scriptType"
                              label="脚本类型">
                ...
                <el-form-item v-if="flowConditionForm.scriptType === 'inlineScript'"
                              key="body"
                              label="脚本">
                    <el-input v-model="flowConditionForm.body"
                              type="textarea"
                ...
                <el-form-item v-if="flowConditionForm.scriptType === 'externalScript'"
                              key="resource"
                              label="资源地址">
