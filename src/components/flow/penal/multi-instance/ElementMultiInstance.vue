        ...
        <el-form size="mini"
            ...
            <template v-if="loopCharacteristics === 'ParallelMultiInstance' || loopCharacteristics === 'SequentialMultiInstance'">
                ...
                <el-form-item key="async"
                    ...
                    <el-checkbox v-if="loopInstanceForm.asyncAfter || loopInstanceForm.asyncBefore"
                                 v-model="loopInstanceForm.exclusive"
                                 label="排除"
                                 @change="updateLoopAsync('exclusive')" />
                </el-form-item>
                <el-form-item v-if="loopInstanceForm.asyncAfter || loopInstanceForm.asyncBefore"
                              key="timeCycle"
                              label="重试周期"
                              prop="timeCycle">
