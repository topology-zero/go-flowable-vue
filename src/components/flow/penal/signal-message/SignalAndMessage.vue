    ...
    <div class="panel-tab__content">
        <div class="panel-tab__content--title">
            <span><i class="el-icon-menu"
                     style="margin-right: 8px; color: #555555" />消息列表</span>
            <el-button size="mini"
                       type="primary"
                       icon="el-icon-plus"
        ...
        <div class="panel-tab__content--title"
            ...
            <span><i class="el-icon-menu"
                     style="margin-right: 8px; color: #555555" />信号列表</span>
            <el-button size="mini"
                       type="primary"
                       icon="el-icon-plus"
        ...
        <el-dialog :visible.sync="modelVisible"
            ...
            <template slot="footer">
                <el-button size="mini"
                           @click="modelVisible = false">取 消</el-button>
                <el-button size="mini"
                           type="primary"
