    ...
    <div style="margin-top: 16px">
        <el-form-item label="消息实例">
            <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: nowrap">
                <el-select v-model="bindMessageId"
                           @change="updateTaskMessage">
                    <el-option v-for="k in Object.keys(messageMap)"
                               :key="k"
                               :value="k"
                               :label="messageMap[k]" />
                </el-select>
        ...
        <el-dialog :visible.sync="messageModelVisible"
            ...
            <el-form :model="newMessageForm"
                ...
                <el-form-item label="消息ID">
                    <el-input v-model="newMessageForm.id"
                              clearable />
                </el-form-item>
            ...
            <template slot="footer">
                <el-button size="mini"
                           type="primary"
                           @click="createNewMessage">确 认</el-button>
            </template>
        </el-dialog>
    </div>
</template>
