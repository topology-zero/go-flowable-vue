<template>
    <div class="panel-tab__content">
        ...
        <el-drawer :visible.sync="listenerFormModelVisible"
            ...
            <el-form ref="listenerFormRef"
                ...
                <el-form-item label="事件类型"
                    ...
                    <el-select v-model="listenerForm.event">
                        <el-option v-for="i in Object.keys(listenerEventTypeObject)"
                                   :key="i"
                                   :label="listenerEventTypeObject[i]"
                                   :value="i" />
                    </el-select>
                </el-form-item>
                <el-form-item label="监听器ID"
                              prop="id"
                              :rules="{ required: true, trigger: ['blur', 'change'] }">
                    <el-input v-model="listenerForm.id"
                              clearable />
                </el-form-item>
                <el-form-item label="监听器类型"
                    ...
                    <el-select v-model="listenerForm.listenerType">
                        <el-option v-for="i in Object.keys(listenerTypeObject)"
                                   :key="i"
                                   :label="listenerTypeObject[i]"
                                   :value="i" />
                    </el-select>
                </el-form-item>
                <el-form-item v-if="listenerForm.listenerType === 'classListener'"
                              key="listener-class"
                              label="Java类"
                              prop="class"
                              :rules="{ required: true, trigger: ['blur', 'change'] }">
                ...
                <el-form-item v-if="listenerForm.listenerType === 'expressionListener'"
                ...
                <el-form-item v-if="listenerForm.listenerType === 'delegateExpressionListener'"
                ...
                <template v-if="listenerForm.listenerType === 'scriptListener'">
                    <el-form-item key="listener-script-format"
                                  label="脚本格式"
                                  prop="scriptFormat"
                    ...
                    <el-form-item key="listener-script-type"
                                  label="脚本类型"
                                  prop="scriptType"
                    ...
                    <el-form-item v-if="listenerForm.scriptType === 'inlineScript'"
                                  key="listener-script"
                                  label="脚本内容"
                                  prop="value"
                                  :rules="{ required: true, trigger: ['blur', 'change'], message: '请填写脚本内容' }">
                        <el-input v-model="listenerForm.value"
                                  clearable />
                    </el-form-item>
                    <el-form-item v-if="listenerForm.scriptType === 'externalScript'"
                ...
                <template v-if="listenerForm.event === 'timeout'">
                    <el-form-item key="eventDefinitionType"
                                  label="定时器类型"
                                  prop="eventDefinitionType">
                        <el-select v-model="listenerForm.eventDefinitionType">
                            <el-option label="日期"
                                       value="date" />
                            <el-option label="持续时长"
                                       value="duration" />
                            <el-option label="循环"
                                       value="cycle" />
                            <el-option label="无"
                    ...
                    <el-form-item v-if="!!listenerForm.eventDefinitionType && listenerForm.eventDefinitionType !== 'null'"
                        ...
                        <el-input v-model="listenerForm.eventTimeDefinitions"
                                  clearable />
                    </el-form-item>
                </template>
            </el-form>
            ...
            <el-table :data="fieldsListOfListener"
                      size="mini"
                      max-height="240"
                      border
                      fit
        ...
        <el-dialog title="字段配置"
                   ...
                   append-to-body
                   destroy-on-close>
            <el-form ref="listenerFieldFormRef"
                ...
                <el-form-item label="字段类型："
                    ...
                    <el-select v-model="listenerFieldForm.fieldType">
                        <el-option v-for="i in Object.keys(fieldTypeObject)"
                                   :key="i"
        ...
        resetListenersList() {
            ...
            if (this.bpmnElement.businessObject && this.bpmnElement.businessObject.extensionElements && this.bpmnElement.businessObject.extensionElements.values) {
                this.bpmnElement.businessObject.extensionElements.values.forEach(e => {
                    if (e.$type === `${this.prefix}:TaskListener`) {
